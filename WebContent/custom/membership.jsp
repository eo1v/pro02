...
<style>
	.agree_fr { width: 900px; white-space:pre-wrap; margin: 10px auto; 
    	padding: 24px; border:2px solid #eee; height:300px; overflow-y:auto; }
...
<div class="btn_fr">
                ...
                <label for="ck_item1">약관의 동의</label><br><br><br>
            </div>
        
<div class="content container" id="content">
	<h2 class="title">개인 정보 활용 동의</h2>
	<form name="frm1" id="frm1" action="../insertCustom.jsp" method="post" >
<div class="agree_fr">
가. 개인정보의 수집 및 이용 목적
...
<div class="btn_fr">
                <input type="checkbox" id="ck_item1" name="ck_item1"> 
                <label for="ck_item1">약관의 동의</label><br>
                <button type="button" id="in_btn1" class="btn btn_info">다음 단계</button>
            </div>
            <script>
