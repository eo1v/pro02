...
select * from custom;
-- 고객 비밀번호의 암호화
update custom set cuspw="03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4" where cusid="hsy123";
update custom set cuspw="0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c" where cusid="admin";
-- 관리자의 등급 변경
...
drop table category;
-- 카테고리 데이터 등록
insert into category(cateName) values ("아이스크림");
insert into category(cateName) values ("아이스크림 케이크");
...
select * from qnaa;
insert into qnaa(title, content, author, lev, parno, sec)  values ("문의 합니다. 테스트 글1", "문의 합니다. 테스트 글1의 내용입니다.", "hsy123", 0, 1, "N");
alter table qnaa add column visited int default 0; 
alter table qnaa modify column parno int default 0;
select * from qnaa;
drop table qnaa;
